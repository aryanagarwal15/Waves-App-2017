...
public class Day2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myFragmentView = inflater.inflate(R.layout.activity_day2, container, false);

        RecyclerView recyclerView = (RecyclerView) myFragmentView.findViewById(R.id.recycle2);
